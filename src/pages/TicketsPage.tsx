            ...
            <div className={SIATC_THEME.LAYOUT.CONTENT_CONTAINER}>
                <div className="p-4 space-y-4 flex-1 min-h-0 overflow-y-auto custom-scrollbar bg-cb-bg">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3">
                        ...
                        >
                            <Filter className="w-4 h-4" /> {t('tickets_bandeja.filtros')}
                        </button>
                        <div className="flex gap-3 flex-1">
                            <div className="relative flex-1">
                                ...
                                <input
                                    ...
                                    placeholder={t('tickets_bandeja.search_placeholder')}
                            ...
                            <button
                                ...
                                disabled={loading}
                                title={t('tickets_bandeja.reintentar')}
                    ...
                    {!error && !loading && items.length === 0 && (
                        <p className="text-sm text-cb-text-secondary text-center py-12">{t('tickets_bandeja.vacio')}</p>
                    )}

                    <div className="space-y-3">
                        {items.map(item => (
                            <TicketCard key={item.numero} ticket={item} onVer={handleVer} />
                        ))}
                    </div>
