...
const ESTADO_BADGE: Record<1 | 2, string> = {
    1: 'bg-amber-500/15 text-amber-700 border-amber-400/30',
    2: 'bg-emerald-500/15 text-emerald-700 border-emerald-400/30',
};
    ...
    return (
        <div className="border border-cb-border rounded-xl px-4 py-2.5 bg-card hover:bg-cb-bg/40 transition-colors duration-150">
            ...
            <div className="flex items-center gap-2 flex-wrap min-w-0">
                ...
                <span className={cn('shrink-0 text-[9px] font-black uppercase tracking-wider px-2 py-0.5 rounded-full border', ESTADO_BADGE[exhibicion.estadoId])}>
                    {estadoLabel}
                </span>
                {fechaTexto && (
